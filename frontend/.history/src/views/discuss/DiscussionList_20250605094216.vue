              ...
              <div class="create-modal-content">
                ...
                <div class="create-modal-body">
                  ...
                  <div class="progress-indicator">
                    ...
                    <div class="progress-step" :class="{'active': !titleError && !contentError && newThread.title.length > 3 && getContentLength() > 10}">
                      <div class="step-circle">
                ...
                <div class="create-modal-footer enhanced-footer">
                  ...
                  <div class="footer-buttons">
                    ...
                    <button 
                      ...
                      :disabled="creatingThread || titleError || contentError || !newThread.title.trim() || !newThread.content.trim()" 
                      class="btn btn-primary enhanced-btn-primary"
                    >
                      <i class="fa" :class="creatingThread ? 'fa-spinner fa-spin' : 'fa-rocket'"></i>
                      <span>{{ creatingThread ? '发布中...' : '发布讨论' }}</span>
                    </button>
                  </div>
                </div>
              </div>
