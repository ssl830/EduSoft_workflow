...
.content-editor-wrapper.focused {
  border-color: var(--primary);
  box-shadow: 0 0 0 4px rgba(102, 126, 234, 0.2);
  transform: translateY(-2px);
}

.content-editor-wrapper.error {
  border-color: var(--danger);
  background: rgba(245, 101, 101, 0.05);
  animation: error-shake 0.5s ease-in-out;
}

.content-editor-wrapper.success {
  border-color: var(--success);
...
/* 优化Quasar编辑器工具栏样式 */
.enhanced-editor :deep(.q-editor__toolbar) {
...
.enhanced-editor :deep(.q-btn:hover) {
  background: rgba(102, 126, 234, 0.1);
  border-color: rgba(102, 126, 234, 0.3);
  transform: translateY(-1px);
...
.enhanced-editor :deep(.q-btn.q-btn--active) {
  background: linear-gradient(135deg, var(--primary), var(--secondary));
  color: white;
...
.enhanced-editor :deep(.q-editor__content) {
  min-height: 200px;
  max-height: 400px;
  padding: 1.5rem;
  background: rgba(255, 255, 255, 0.95);
...
.enhanced-editor :deep(.q-editor__content:focus) {
  outline: none;
  background: rgba(255, 255, 255, 1);
}

/* 工具栏图标优化 */
.enhanced-editor :deep(.q-icon) {
  font-size: 1.1rem;
  color: var(--text-secondary);
  transition: color 0.2s ease;
}

.enhanced-editor :deep(.q-btn:hover .q-icon) {
  color: var(--primary);
}

.enhanced-editor :deep(.q-btn--active .q-icon) {
  color: white;
}
</style>
