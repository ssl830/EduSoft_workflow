...
<!--                        {{-->
<!--                            exercise.type === 'unFinished' ? '未开始' :-->
<!--                                exercise.type === 'unScored' ? '待批改' :-->
<!--                                    exercise.type === 'Scored' ? '已批改' : '已截止'-->
<!--                        }}-->
<!--                    </div>-->
<!--                </div>-->
...
<!--                            <span class="info-value">{{ formatDate(exercise.start_time) }}</span>-->
<!--                        </div>-->
<!--                        <div class="info-row">-->
<!--                            <span class="info-label">截止时间:</span>-->
<!--                            <span class="info-value">{{ formatDate(exercise.end_time) }}</span>-->
<!--                        </div>-->
<!--                        <div class="info-row">-->
