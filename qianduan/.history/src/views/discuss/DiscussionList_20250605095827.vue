            ...
            <div class="create-modal-container">
              <div class="create-modal-content">
                <div class="create-modal-header">
                  <h2><i class="fa fa-plus-circle"></i> 创建新讨论</h2>
                  <button class="close-modal-btn" @click="showCreateInput = false">
                    <i class="fa fa-times"></i>
                  </button>
                </div>
                
                <div class="create-modal-body">                  <div class="form-group">
                    <div class="form-label-container">
                      <label for="thread-title">讨论标题</label>
                      <div class="char-count" :class="{'warning': newThread.title.length > 80, 'error': newThread.title.length > 100}">
                        {{ newThread.title.length }}/100
                      </div>
                    </div>
                    <input 
                      id="thread-title" 
                    ...
                    />
                    <div class="form-hint">
                      <span v-if="titleError" class="form-error"><i class="fa fa-exclamation-circle"></i> {{ titleError }}</span>
                      <span v-else class="form-tip"><i class="fa fa-lightbulb-o"></i> 好的标题能够吸引更多人参与讨论</span>
                    </div>
                  </div>
                  
                  <div class="form-group">
                    <div class="form-label-container">
                      <label for="thread-content">讨论内容</label>
                      <div class="char-count" :class="{'warning': getContentLength() > 2000, 'error': getContentLength() > 3000}">
                        {{ getContentLength() }}/3000
                      </div>
                    </div>
                    <div ref="contentEditorContainer" :class="{'focus-container': contentFocused}">
                      <WriteBoard 
                    ...
                    <div class="form-hint">
                      <span v-if="contentError" class="form-error"><i class="fa fa-exclamation-circle"></i> {{ contentError }}</span>
                      <span v-else class="form-tip"><i class="fa fa-lightbulb-o"></i> 详细的内容有助于他人理解你的问题或观点</span>
                    </div>
                  </div>
                  
                  <div v-if="createThreadError" class="form-error-global">
                    <i class="fa fa-times-circle"></i> {{ createThreadError }}
                  </div>
                </div>
                
                <div class="create-modal-footer">
                  <button @click="showCreateInput = false" class="btn btn-secondary">
                  ...
                  >
                    <i class="fa" :class="creatingThread ? 'fa-spinner fa-spin' : 'fa-paper-plane'"></i>
                    {{ creatingThread ? '提交中...' : '发布讨论' }}
                  </button>
                </div>
              </div>
            </div>
