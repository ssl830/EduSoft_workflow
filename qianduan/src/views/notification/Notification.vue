            ...
            <form @submit.prevent="saveNotificationSettings">
              ...
              <div class="form-group" v-if="notificationSettings.enableDeadlineReminders">
                ...
                <div class="reminder-times">
                  <div v-for="(day, index) in notificationSettings.reminderDays" :key="index" class="reminder-time">
                    <input 
                      type="number" 
...
import notificationApi, { type Notification, type PersonalTask } from '@/api/notification';
